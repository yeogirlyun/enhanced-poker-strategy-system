...
class PurePokerStateMachineTestSuite:
    ...
    def test_hand_startup_and_blinds(self):
        ...
        self.log_test(
            ...
            f"Pot: ${ppsm.game_state.pot} (expected: ${expected_pot})"
        )
    ...
    def test_action_execution(self):
        ...
        actual_pot = ppsm.game_state.pot
    ...
    def test_pot_and_stack_tracking(self):
        ...
        # After blinds
        total_after_blinds = sum(p.stack for p in ppsm.game_state.players) + ppsm.game_state.pot
        ...
        if ppsm._is_valid_action(action_player, ActionType.RAISE, raise_amount):
            ...
            total_after_raise = sum(p.stack for p in ppsm.game_state.players) + ppsm.game_state.pot
