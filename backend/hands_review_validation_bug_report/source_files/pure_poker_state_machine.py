    ...
    def get_decision(self, player_name: str, game_state) -> tuple:
        ...
        while self.current_action_index < len(self.actions_for_replay):
            ...
            if current_action.actor_uid == player_name:
                ...
                # Default BB=10.0 for raise heuristics; many datasets use 10
                bb   = getattr(game_state, "big_blind", 10.0)
                ...
                # to BET, inject an implicit CHECK for the current player. Do NOT
                # advance the hand-model pointer (we haven't consumed anything).
                ...
                # Do not consume the model action; let PPSM advance seats.
                return None
