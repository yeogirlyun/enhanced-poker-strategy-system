...
class TableScheme:
    ...
    def __init__(self, name: str, felt_color: str, rail_color: str, 
                 border_color: str, background_color: str, pattern: str, notes: str,
                 texture_type: str = "solid", gradient_colors: List[str] = None,
                 has_gold_inlay: bool = False, lighting_effect: str = "none"):
        self.name = name
        ...
        self.texture_type = texture_type  # "solid", "gradient", "suede", "diamond", "microfiber", "velvet", "satin"
        self.gradient_colors = gradient_colors or [felt_color]  # For gradient effects
        self.has_gold_inlay = has_gold_inlay  # Gold thread borders
        self.lighting_effect = lighting_effect  # "none", "vignette", "center_glow", "frosted_edge"
...
class TableSchemeManager:
    ...
    # Elite Professional Table Schemes (5 exceptional options) - Inspired by PokerStars, WSOP, and premium casino software
    TABLE_SCHEMES = {
        1: TableScheme(
    ...
    # Default scheme (PokerStars Classic Pro - professional diamond weave with suit watermarks)
    DEFAULT_SCHEME_ID = 1
    ...
    def apply_scheme_to_widget(self, widget, element_type: str = 'felt') -> None:
