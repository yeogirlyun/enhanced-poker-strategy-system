...
class EnhancedPokerEngine:
    ...
    def _get_preflop_action(self, player: Player, game_state: GameState, strength: float) -> Action:
    ...
    def _get_postflop_action(self, player: Player, game_state: GameState, strength: float, hand_rank: str) -> Action:
    ...
    def _log_deviation(self, player: Player, action: Action, game_state: GameState) -> None:
