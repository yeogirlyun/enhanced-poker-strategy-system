...
class AutoAdvancementController(AdvancementController):
    ...
    def on_round_complete(self, street: str, game_state: GameState) -> None:
        ...
        print(f"🤖 AUTO_ADVANCE: Round complete on {street}, pot: ${game_state.pot}")
...
class HumanAdvancementController(AdvancementController):
    ...
    def on_round_complete(self, street: str, game_state: GameState) -> None:
        ...
        print(f"👤 HUMAN_ADVANCE: Round complete on {street}, pot: ${game_state.pot}")
...
class HandsReviewAdvancementController(AdvancementController):
    ...
    def on_round_complete(self, street: str, game_state: GameState) -> None:
        ...
        print(f"📖 HANDS_REVIEW: Round complete on {street}, pot: ${game_state.pot}")
...
class LiveAdvancementController(AdvancementController):
    ...
    def on_round_complete(self, street: str, game_state: GameState) -> None:
        ...
        print(f"🎮 LIVE_PLAY: Round complete on {street}, pot: ${game_state.pot} ({human_count} humans, {bot_count} bots active)")
