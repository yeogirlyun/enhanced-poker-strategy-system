...
try:
    ...
    # Import the reusable poker game widget with proper relative import
    ...
    class HandModelDecisionEngine:
        ...
        def suggest_action(self, *args, **kwargs): return None
    
    class LegendaryToHandConverter:
        def convert_legendary_hand(self, data): return Hand(**data)
    
    def is_legendary_hand_obj(data): return True
