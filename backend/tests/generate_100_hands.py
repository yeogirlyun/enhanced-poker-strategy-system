...
def generate_hero_calls() -> List[Dict[str, Any]]:
    ...
    high_cards = [
        (
            ...
            "Ah",
            "Jd",
            "Calling massive river bet with just ace-high",
        ),
        (
            "Queen-High",
            "Qd",
            "Jh",
            "Instant call with queen-high vs massive bluff",
        ),
        ...
        (
            ...
            "Th",
            "9d",
            "Calling with ten-high vs aggressive opponent",
        ),
        ...
        (
            ...
            "8h",
            "7d",
            "Calling with eight-high vs aggressive line",
        ),
        ...
        (
            ...
            "6h",
            "5d",
            "Calling with six-high vs aggressive opponent",
        ),
...
def generate_massive_bluffs() -> List[Dict[str, Any]]:
    ...
    bluff_scenarios = [
        (
            "Moneymaker's Bluff",
            "The bluff that started the poker boom",
            "2003 WSOP Main Event",
        ),
        (
            "Dwan's 7-2",
            "Bluffing with the worst hand vs two strong hands",
            "WPT Championship",
        ),
        (
            "Ivey's Triple Barrel",
            "Triple barrel bluff with air",
            "High Stakes Poker",
        ),
        (
            "Negreanu's Soul Read",
            "Bluffing based on opponent tells",
            "Poker After Dark",
        ),
...
def generate_wsop_championship_hands() -> List[Dict[str, Any]]:
    ...
    wsop_scenarios = [
        (
            "Scotty Nguyen 1998",
            "Scotty's famous 'You call, gonna be all over baby'",
            1998,
        ),
        (
            "Chris Moneymaker 2003",
            "The hand that started the poker boom",
            2003,
        ),
...
def generate_heads_up_duels() -> List[Dict[str, Any]]:
    ...
    duel_scenarios = [
        ...
        (
            "Four vs Three",
            "Four-three vs three-two",
            ["4h", "3d"],
            ["3c", "2s"],
        ),
        (
            "Ace vs Queen",
            "Ace-queen vs queen-jack",
            ["Ah", "Qd"],
            ["Qc", "Js"],
        ),
    ...
    for i, (name, desc, num_players) in enumerate(multi_way_scenarios):
        hand = {
            ...
            "setup": {
                ...
                "player_cards": [["Ah", "Kh"], ["Qd", "Jc"], ["9s", "8h"]]
                + [["7d", "6c"]] * (num_players - 3),
            },
