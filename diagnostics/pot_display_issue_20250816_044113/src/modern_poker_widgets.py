...
class BetSliderWidget(tk.Frame):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(parent, bg="#2f3b4a", **kwargs)
...
class ModernActionButton(tk.Button):
    ...
    def set_enabled(self, enabled: bool):
        ...
        if enabled:
            ...
            self.config(state="disabled", bg="#4a5568")
...
class ChipStackDisplay(tk.Frame):
    ...
    def __init__(
        ...
        super().__init__(parent, bg="#0a3d2e", **kwargs)

        self.amount = amount
        self.title = title or "Chips"
    ...
    def _create_widgets(self):
        ...
        # Title label (hidden by default for clean look)
        self.title_label = tk.Label(
            self,
            text="",  # keep as empty string for type checkers
            font=("Arial", 10),
            fg="#9aa0a6",
            bg="#0a3d2e",
        )
    ...
    def _get_chip_color(self, value: float) -> str:
        ...
        if value >= 100:
            return "#111111"  # high-value chips (stack/pot)
        elif value >= 25:
            return "#1faa00"  # medium (pot)
        elif value >= 5:
            return "#d32f2f"    # low (bet/call)
        else:
            return "#1976d2"   # small change
