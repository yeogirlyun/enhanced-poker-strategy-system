#!/usr/bin/env python3
"""
Decision Engine v2 - Abstract base and implementations
...
- HandModelDecisionEngine for replaying recorded hands
- UserStrategyDecisionEngine for user-defined strategies
